...
extern UniValue setzankseed(const UniValue& params, bool fHelp);
extern UniValue getzankseed(const UniValue& params, bool fHelp);
...
extern UniValue listcoldstakers(const UniValue& params, bool fHelp);
extern UniValue coldstakerscount(const UniValue& params, bool fHelp);
extern UniValue aliasescount(const UniValue& params, bool fHelp);
