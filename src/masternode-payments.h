...
void FillBlockPayee(CMutableTransaction& txNew, CAmount nFees, bool fProofOfStake, CScript *rpayee = NULL);
...
public:
    ...
    void ProcessMessageMasternodePayments(CNode* pfrom, std::string& strCommand, CDataStream& vRecv);
    std::string GetRequiredPaymentsString(int nBlockHeight);
    void FillBlockPayee(CMutableTransaction& txNew, int64_t nFees, bool fProofOfStake, CScript *rpayee = NULL);
