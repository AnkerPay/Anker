...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Anker features */
        {"anker", "masternode", &masternode, true, true, false},
        {"anker", "listmasternodes", &listmasternodes, true, true, false},
        {"anker", "listcoldstakers", &listcoldstakers, true, true, false},
        {"anker", "coldstakerscount", &coldstakerscount, true, true, false},
        {"anker", "aliasescount", &aliasescount, true, true, false},
        {"anker", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"anker", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"anker", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"anker", "getmasternodecount", &getmasternodecount, true, true, false},
        {"anker", "masternodeconnect", &masternodeconnect, true, true, false},
        {"anker", "masternodecurrent", &masternodecurrent, true, true, false},
        {"anker", "masternodedebug", &masternodedebug, true, true, false},
        {"anker", "startmasternode", &startmasternode, true, true, false},
        {"anker", "createmasternodekey", &createmasternodekey, true, true, false},
        {"anker", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"anker", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"anker", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"anker", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"anker", "getmasternodescores", &getmasternodescores, true, true, false},
        {"anker", "mnbudget", &mnbudget, true, true, false},
        {"anker", "preparebudget", &preparebudget, true, true, false},
        {"anker", "submitbudget", &submitbudget, true, true, false},
        {"anker", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"anker", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"anker", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"anker", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"anker", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"anker", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"anker", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"anker", "checkbudgets", &checkbudgets, true, true, false},
        {"anker", "mnsync", &mnsync, true, true, false},
        {"anker", "spork", &spork, true, true, false},
        {"anker", "getpoolinfo", &getpoolinfo, true, true, false},
        {"anker", "makekeypair", &makekeypair, true, true, false},
        ...
        {"anker", "searchcoldstakinghash", &searchcoldstakinghash, true, true, true},
#ifdef ENABLE_WALLET
        /* Wallet */
...
{
    return "> anker-cli " + methodname + " " + args + "\n";
}
