...
UniValue getpoolinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "\nResult:\n"
            "{\n"
            "  \"current\": \"addr\",    (string) Anker address of current masternode\n"
...
UniValue masternode(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp ||
        ...
        throw runtime_error(
            ...
            "  start        - Start masternode configured in anker.conf\n"
...
UniValue listmasternodes(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || (params.size() > 1))
        throw runtime_error(
            ...
            "    \"addr\": \"addr\",      (string) Masternode anker address\n"
...
UniValue listcoldstakers(const UniValue& params, bool fHelp)
{

    if (fHelp || (params.size() > 0))
        throw runtime_error(
            "listcoldstakers \n"
            "\nGet a list of cold stakers\n"
            "\nExamples:\n" +
...
UniValue coldstakerscount(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || (params.size() > 0))
        throw runtime_error(
            "coldstakerscount \n"
            "\nGet a count of cold stakers\n"
            "\nExamples:\n" +
            HelpExampleCli("coldstakerscount", "") + HelpExampleRpc("coldstakerscount", ""));

    return (int)colstaklist.mapColdStaking.size();
}


UniValue aliasescount(const UniValue& params, bool fHelp)
{

    if (fHelp || (params.size() > 0))
        throw runtime_error(
            "aliasescount \n"
            "\nGet a count of email aliases\n"
            "\nExamples:\n" +
            HelpExampleCli("aliasescount", "") + HelpExampleRpc("aliasescount", ""));

    return (int)mapAliasesHash.size();
}
...
UniValue masternodeconnect(const UniValue& params, bool fHelp)
{
    if (fHelp || (params.size() != 1))
        throw runtime_error(
            ...
            "\nExamples:\n" +
            HelpExampleCli("masternodeconnect", "\"192.168.0.6:12365\"") + HelpExampleRpc("masternodeconnect", "\"192.168.0.6:12365\""));
...
UniValue getmasternodestatus (const UniValue& params, bool fHelp)
{
    if (fHelp || (params.size() != 0))
        throw runtime_error(
            ...
            "  \"addr\": \"xxxx\",        (string) Anker address for masternode payments\n"
            "  \"status\": \"xxxx\",      (string) Masternode status\n"
...
UniValue getmasternodewinners (const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 3)
        throw runtime_error(
            ...
            "    \"winner\": {\n"
            "      \"address\": \"xxxx\",    (string) Anker MN address\n"
