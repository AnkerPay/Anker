...
void ReceiveRequestDialog::setEmail(QString email)
{
    this->email = email;
}
...
void ReceiveRequestDialog::update()
{
    ...
    if (!this->email.isEmpty())
        html += "<b>" + tr("Send to Email") + "</b>: " + GUIUtil::HtmlEscape(this->email) + "<br>";
...
{
    if (!this->email.isEmpty()) {
        kycinfo.SendInvoice(QUrl::toPercentEncoding(GUIUtil::formatBitcoinURI(info)).toStdString(), this->email.toStdString());
    }
    QDialog::accept();
}
