...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted Ank to zAnk");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zAnk");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received Ank from zAnk");
    case TransactionRecord::ZerocoinSpend_Change_zAnk:
        return tr("Minted Change as zAnk from zAnk Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zAnk to Ank");
...
{
    QString str = BitcoinUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), (wtx->debit + wtx->credit), false, separators);
    if (showUnconfirmed) {
