...
/** Utility functions used by the Anker Qt UI.
 */
namespace GUIUtil
{
...
// Render Anker addresses in monospace font
...
// Parse "anker:" URI into recipient object, return true on successful parsing
