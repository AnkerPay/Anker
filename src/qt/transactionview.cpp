 ...
 */
    ...
    typeWidget->addItem(tr("POS"), TransactionFilterProxy::TYPE(TransactionRecord::MNReward));
    typeWidget->addItem(tr("Received Ank from zAnk"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zAnk"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zAnk));
