...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total anker balance of the wallet (excluding zerocoins)\n"
            ...
            "  \"zANKsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zANK denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zANK denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zANK denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zANK denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zANK denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zANK denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zANK denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zANK denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zANK denominations\n"
            "  }\n"
            "  \"keypoololdest\": xxxxxx,    (numeric) the timestamp (seconds since GMT epoch) of the oldest pre-generated key in the key pool\n"
            "  \"keypoolsize\": xxxx,        (numeric) how many new keys are pre-generated\n"
            "  \"unlocked_until\": ttt,      (numeric) the timestamp in seconds since epoch (midnight Jan 1 1970 GMT) that the wallet is unlocked for transfers, or 0 if the wallet is locked\n"
            "  \"paytxfee\": x.xxxx,         (numeric) the transaction fee set in anker/kb\n"
            "  \"relayfee\": x.xxxx,         (numeric) minimum relay fee for non-free transactions in anker/kb\n"
    ...
    obj.push_back(Pair("zANKsupply", zphrObj));
...
UniValue createmultisig(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2) {
        string msg = "createmultisig nrequired [\"key\",...]\n"
                     ...
                     "2. \"keys\"       (string, required) A json array of keys which are anker addresses or hex-encoded public keys\n"
                     "     [\n"
                     "       \"key\"    (string) anker address or hex-encoded public key\n"
                     "       ,...\n"
                     "     ]\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"ankeraddress\"  (string, required) The anker address to use for the signature.\n"
