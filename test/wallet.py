...
#   c) node1 mines 32 blocks, so now node 0 has 60001ank, node 1 has 4250ank, node2 has none.
#   d) node0 sends 601 ank to node2, in two transactions (301 ank, then 300 ank).
