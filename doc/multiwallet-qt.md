...
In order to support loading of multiple wallets in anker-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is anker.cpp.
...
Changes to anker.cpp
----------------------
anker.cpp is the entry point into anker-qt, and as such, will require some minor modifications to provide hooks for
