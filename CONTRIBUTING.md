Contributing to Anker Core
============================

The Anker Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Anker Core project, and is not to be
confused with overall Anker Network Protocol consensus changes.

Whether a pull request is merged into Anker Core rests with the project merge
...
Patches that change Anker consensus rules are considerably more involved than
...
Where a patch set proposes to change the Anker consensus, it must have been
...
The project leader is the release manager for each Anker Core release.
